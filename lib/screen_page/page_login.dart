...
import 'package:uas_mobile/screen_page/page_bottom_navigation.dart';
import 'package:uas_mobile/screen_page/page_register.dart';
  ...
  Future<ModelLogin?> loginAccount() async {
    try {
      ...
      http.Response res = await http
          .post(Uri.parse('http://192.168.100.128/uas_mobile/login.php'), body: {
      ...
      if (data.value == 1) {
        setState(() {
          ...
          Navigator.pushAndRemoveUntil(
              context,
              MaterialPageRoute(
                  builder: (context) => const PageBottomNavigationBar()),
              (route) => false);
        });
      } else {
        setState(() {
      ...
      bottomNavigationBar: Padding(
        ...
        child: MaterialButton(
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(builder: (context) => PageRegisterNew()),
                (route) => false);
          },
