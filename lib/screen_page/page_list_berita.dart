...
import 'package:uas_mobile/screen_page/page_login.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.100.128/uas_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        'http://192.168.100.128/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )),
                                ListTile(
